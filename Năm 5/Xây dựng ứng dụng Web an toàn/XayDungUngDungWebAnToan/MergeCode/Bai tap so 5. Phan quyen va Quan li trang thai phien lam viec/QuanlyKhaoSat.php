<div id="tableInforKH" style="margin: 60px 0px 10px 280px;">
    ...
    <table class="table align-middle mb-0 bg-white">
        ...
        <tbody>
            <?php
            $getUsernameLogin=$_COOKIE['User'];
            $connect = mysqli_connect("localhost", "root", "", "at150252");
            $sql = " SELECT * FROM `35dangtienthanh_quanlykhaosat` WHERE Username='$getUsernameLogin'";
                            ...
                            <tr>
                                ...
                                <td><span style="cursor: pointer;" class="dropdown-toggle" id="dropdownMenuLink" data-mdb-toggle="dropdown" aria-expanded="false">Thao tác
                                    ...
                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                        <li><a class="dropdown-item" href="http://localhost/XayDungUngDungWebAnToan/MergeCode/Bai%20tap%20so%205.%20Phan%20quyen%20va%20Quan%20li%20trang%20thai%20phien%20lam%20viec/bootstrap-5-admin-template-main/KH.php?click=QLKS&thaotac=ThemCHKS&ndks='.$row['NDRequest']."&id=".$row['MaKH'].'">Thêm câu hỏi khảo sát</a></li>
                                        <li><a class="dropdown-item" href="http://localhost/XayDungUngDungWebAnToan/MergeCode/Bai%20tap%20so%205.%20Phan%20quyen%20va%20Quan%20li%20trang%20thai%20phien%20lam%20viec/bootstrap-5-admin-template-main/KH.php?click=QLKS&thaotac=XemKQKS&id='.$row['MaKH'].'">Xem kết quả khảo sát</a></li>
                                        <li><a class="dropdown-item" href="http://localhost/XayDungUngDungWebAnToan/MergeCode/Bai%20tap%20so%205.%20Phan%20quyen%20va%20Quan%20li%20trang%20thai%20phien%20lam%20viec/bootstrap-5-admin-template-main/KH.php?click=QLKS&thaotac=DSNTGKS&id='.$row['MaKH']."&Price=".$row['GiaTien'].'">Danh sách người tham gia khảo sát</a></li><!-- MaKH là MaKS -->
                                    </ul>
                                </td>
                            </tr>';
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                if (isset($_POST['ThemKS'])) {
                    // Check quyền tạo khảo sát
                // Quyền tạo khảo sát bit đầu là 1, 0 là không được tạo (0111)
                ...
                // Check quyền
                if($getRightAddSurvey[0]==="0"){
                    echo '<script>window.location.href="?click=NoRightAddSurvey"</script>';
                }
                else{
