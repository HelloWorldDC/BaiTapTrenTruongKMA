        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                if (isset($_POST['ThemPersonJoinKS'])) {
                    // Check quyền thêm người tham gia khảo sát
                    // Quyền thêm người tham gia khảo sát bit thứ 2 là 1, 0 là không có quyền thêm (1011)
                    ...
                    if ($getRightAddSurvey[1] === "0") {
                        echo '<script>window.location.href="?click=NoRightAddPersonJoinKS"</script>';
                    } else {
                        $getNDKS = "";
                        $getMaKS = $_GET['id'];
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                if (isset($_POST['SuaPersonJoinKS'])) {
                    // Check quyền sửa người tham gia khảo sát
                    // Quyền sửa người tham gia khảo sát bit thứ 3 là 1, 0 là không có quyền sửa (1101)
                    $getInforUser = $_COOKIE['User'];
                    $getRightAddSurvey = "";
                    $sql = "SELECT * FROM `35dangtienthanh_inforuser` WHERE Username='$getInforUser'";
                    $query = mysqli_query($connect, $sql);
                    ...
                    if ($getRightAddSurvey[2] === "0") {
                        echo '<script>window.location.href="?click=NoRightEditPersonJoinKS"</script>';
                    }
                ...
                if (isset($_POST['XoaPersonJoinKS'])) {
                    // Check quyền xóa người tham gia khảo sát
                    // Quyền xóa người tham gia khảo sát bit thứ 4 là 1, 0 là không có quyền xóa (1110)
                    $getInforUser = $_COOKIE['User'];
                    $getRightAddSurvey = "";
                    $sql = "SELECT * FROM `35dangtienthanh_inforuser` WHERE Username='$getInforUser'";
                    $query = mysqli_query($connect, $sql);
                    ...
                    // Check quyền xóa
                    if ($getRightAddSurvey[3] === "0") {
                        echo '<script>window.location.href="?click=NoRightDeletePersonJoinKS"</script>';
                    }
